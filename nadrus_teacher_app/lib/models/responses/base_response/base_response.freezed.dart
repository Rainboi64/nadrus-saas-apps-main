...
mixin _$BaseResponse<T> {
  ...
  T? get data => throw _privateConstructorUsedError; // bool? success,
...
class _$_BaseResponse<T> implements _BaseResponse<T> {
  const _$_BaseResponse(
      {this.message, this.data, @JsonKey(name: 'status_code') this.statusCode});
...
// bool? success,
  ...
  @override
  String toString() {
    return 'BaseResponse<$T>(message: $message, data: $data, statusCode: $statusCode)';
  }
