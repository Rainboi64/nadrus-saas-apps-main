...
mixin _$Unit {
  ...
  int? get nthUnit => throw _privateConstructorUsedError;
...
abstract class $UnitCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {int? id, int? nthUnit, String? title, int? subjectId, Subject? subject});
    ...
    return _then(_value.copyWith(
      id: freezed == id
          ...
          : id // ignore: cast_nullable_to_non_nullable
              as int?,
      nthUnit: freezed == nthUnit
          ? _value.nthUnit
          : nthUnit // ignore: cast_nullable_to_non_nullable
              as int?,
      title: freezed == title
          ? _value.title
...
class _$_Unit implements _Unit {
  const _$_Unit(
      {this.id, this.nthUnit, this.title, this.subjectId, this.subject});
  ...
  @override
  String toString() {
    return 'Unit(id: $id, nthUnit: $nthUnit, title: $title, subjectId: $subjectId, subject: $subject)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.nthUnit, nthUnit) || other.nthUnit == nthUnit) &&
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, nthUnit, title, subjectId, subject);
